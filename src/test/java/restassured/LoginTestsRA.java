...
public class LoginTestsRA {
    ...
    public void loginWrongEmail() {
        AuthRequestDTO auth = AuthRequestDTO.builder()
                .username("margogmail.com").password("Mmar123456$").build();
    ...
    public void loginWrongPasswordFormat() {
        AuthRequestDTO auth = AuthRequestDTO.builder()
                .username("margo@gmail.com").password("Mmar123").build();
    ...
    public void loginUnregistered() {
        AuthRequestDTO auth = AuthRequestDTO.builder()
                .username("margo_new@gmail.com").password("Mmar123456$").build();
